...
def prompt_create_content_abs(faq_questions,lesson_content_text):
  ...
  input_text = f"""
            ...
            **INSTRUCTIONS FOR HANDLING `<!-- delimiter -->` TAGS**
            ...
            2. **ADD NEW DELIMITERS WITH CAUTION**  
            - ONLY ADD NEW `<!-- delimiter -->` TAGS IF IT CREATES A LOGICAL BREAK (E.G., A NEW SUBTOPIC).  
            - ENSURE EACH NEW DELIMITER IS NECESSARY AND DOES NOT CREATE BLANK PAGES.
